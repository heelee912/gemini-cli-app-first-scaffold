...
| 경로 | 공개 안전 예시 |
| --- | --- |
| Near-baseline 1818 스냅샷. 일부 지침은 있었지만 앱 우선 scaffold가 안정화되기 전입니다. | <img src="../evidence/baseline-1818/desktop-fullpage.png" alt="1818 near-baseline snapshot" width="360"> |
| Near-baseline 1848 스냅샷. 첫 화면 안정성은 개선됐지만 여전히 정적 산출물 쪽으로 기울어 있었습니다. | <img src="../evidence/baseline-1848/desktop-fullpage.png" alt="1848 near-baseline snapshot" width="360"> |
