...
이 표의 결과물은 모두 같은 공개 안전 brief를 기준으로 한 원트 결과입니다.

| 경로 | 원트 공개 안전 결과 |
| --- | --- |
| 바닐라 단순 지침 v1 | <img src="../evidence/baseline-1818/desktop-fullpage.png" alt="바닐라 단순 지침 v1 원트 결과" width="520"> |
| 바닐라 단순 지침 v2 | <img src="../evidence/baseline-1848/desktop-fullpage.png" alt="바닐라 단순 지침 v2 원트 결과" width="520"> |
| App-first scaffold 0003 | <img src="../evidence/final-0003/desktop-fullpage.png" alt="App-first scaffold 0003 원트 결과" width="520"> |
...
```text
app-first-design-director profile을 사용한다.
